...
{
    public ClaimValueType(string? uri, string? description = null/*, Action<InlineValidator<C>>? setupValidator = null*/) : this(System.uri.From(uri), description/*, CreateValidator(setupValidator)*/) { }
