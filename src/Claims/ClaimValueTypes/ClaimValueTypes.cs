...
using static JustinWritesCode.Identity.Claims.ClaimTypes.Strings;
using static JustinWritesCode.Identity.Claims.ClaimValueTypes.Strings;
using NS = JustinWritesCode.Identity.Claims.ClaimValueTypes.Namespaces;
public static class ClaimValueTypes
{
    ...
    public static class Strings
    {
        ...
        /// <value><inheritdoc cref="W3CBaseUriString"/><inheritdoc cref="NS.TR"/><inheritdoc cref="NS.XmlSchema11_2"/></value>
        public const string XmlSchema11_2UriString = $"{W3CBaseUriString}{NS.TR}{NS.XmlSchema11_2}";
        /// <summary>
        /// A URI for representing URI claim value types, <inheritdoc cref="AnyUriClaimValueTypeString" path="/value/node()" />
        /// </summary>
        /// <value><inheritdoc cref="XmlSchema11_2UriString" path="/value/node()" /><inheritdoc cref="NS.AnyUriAnchor" path="/value/node()" /></value>
        public const string AnyUriClaimValueTypeString = $"{XmlSchema11_2UriString}{NS.AnyUriAnchor}";
        /// <summary>A URI for representing a phone number</summary>
        /// <value><inheritdoc cref="IdentityClaimBaseUriString" path="/value/node()" /><inheritdoc cref="NS.Schema" path-=/value/node()" /><inheritdoc cref="NS.PhoneNumber" path-=/value/node()" /></value>
        public const string JsonValueTypeUriString =    $"{IdentityClaimBaseUriString}{NS.Schema}{NS.Json}";
        /// <summary>A URI for representing a phone number</summary>
        /// <value><inheritdoc cref="IdentityClaimBaseUriString" path="/value/node()" /><inheritdoc cref="NS.Schema" path-=/value/node()" /><inheritdoc cref="NS.PhoneNumber" path-=/value/node()" /></value>
        public const string PhoneNumberValueTypeUriString = $"{IdentityClaimBaseUriString}{NS.Schema}{NS.PhoneNumber}";
    }
